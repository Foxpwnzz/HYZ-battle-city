...
internal class ConsoleRenderer : IRenderer, IDisposable
{
    ...
    private readonly char[][] _tankUpCharacters =
    [
        [' ', '╔', '╩', '╗'],
        [' ', '╚', '═', '╝']
    ];

    private readonly char[][] _tankDownCharacters =
    [
        [' ', '╔', '═', '╗'],
        [' ', '╚', '╦', '╝']
    ];

    private readonly char[][] _tankRightCharacters =
    [
        ['╔', '═', '╗', '_'],
        ['╚', '═', '╝', ' ']
    ];

    private readonly char[][] _tankLeftCharacters =
    [
        ['_', '╔', '═', '╗'],
        [' ', '╚', '═', '╝']
    ];
    ...
    private static ConsoleColor MapColorFromStaticObject(StaticObject staticObject) => staticObject switch
    {
    ...
    private static char MapCharacterFromStaticObject(StaticObject staticObject) => staticObject switch
    {
